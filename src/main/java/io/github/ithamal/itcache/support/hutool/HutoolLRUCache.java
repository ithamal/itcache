 ...
 */
public class HutoolLRUCache extends HutoolAbstractCache {

    public HutoolLRUCache(String name, CacheSetting setting) {
        super(name, setting);
    }

    @Override
    protected Cache<Object, Object> createNativeCache(int capacity, int timeout) {
        return CacheUtil.newLRUCache(capacity, timeout);
    }
}
